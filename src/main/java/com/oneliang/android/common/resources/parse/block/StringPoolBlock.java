...
public class StringPoolBlock extends ComplexBlock{
...

	{
		...
		this.blockWrapperQueue.add(new BlockWrapper(ID_STRING_COUNT,this.stringCountBlock));//resource type chunk,string count
		this.blockWrapperQueue.add(new BlockWrapper(ID_STYLE_COUNT,this.styleCountBlock));//resource type chunk,style count
		this.blockWrapperQueue.add(new BlockWrapper(ID_FLAGS,this.flagsBlock));//resource type chunk,flags
		this.blockWrapperQueue.add(new BlockWrapper(ID_STRING_START,this.stringStartBlock));//resource type chunk,string start
		this.blockWrapperQueue.add(new BlockWrapper(ID_STYLE_START,this.styleStartBlock));//resource type chunk,styles start,header count 28byte
		this.blockWrapperQueue.add(new BlockWrapper(ID_STRING_OFFSET_ARRAY,this.stringOffsetArrayBlock));//resource string pool,string offset array
		this.blockWrapperQueue.add(new BlockWrapper(ID_STYLE_OFFSET_ARRAY,this.styleOffsetArrayBlock));//resource string pool,style offset array
		this.blockWrapperQueue.add(new BlockWrapper(ID_STRING_CONTENT,this.stringContentBlock));//resource string pool,string content
		this.blockWrapperQueue.add(new BlockWrapper(ID_STYLE_CONTENT,this.styleContentBlock));//resource string pool,style content
	}
...
//					}
	 ...
	 * first int is index of tag name ('b','i', etc.) * second int is tag start
	 * index in string * third int is tag end index in string
	 */
