...
public class TableTypeBlock extends ComplexBlock {
    ...
    private String transformRealValue(int type, int value, String rawValue) {
        ...
        // if (value == TypedValue.DATA_NULL_EMPTY) { // Special case $empty as
        // explicitly defined empty value
        ...
        // // return new ResFloatValue(Float.intBitsToFloat(value), value,
        // rawValue);
        // break;
        // case TypedValue.TYPE_DIMENSION:
        // // return new ResDimenValue(value, rawValue);
        // Logger.log("type:"+type+",data:"+value+","+TypedValue.coerceToString(type,
        // value));
        // dataValue=TypedValue.coerceToString(type, value);
        // break;
        ...
        // }
        // if(dataValue==null){
        // if (type >= TypedValue.TYPE_FIRST_COLOR_INT && type <=
        // TypedValue.TYPE_LAST_COLOR_INT) {
        // Logger.log("type:"+type+",data:"+value+",value:#"+TypedValue.coerceToString(type,
        // value));
        // // return new ResColorValue(value, rawValue);
        // dataValue=TypedValue.coerceToString(type, value);
        // }else if (type >= TypedValue.TYPE_FIRST_INT && type <=
